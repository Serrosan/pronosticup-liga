export const CAMPOS_ADMIN = {
  ...
  equipos: {
    ...
    campos: [
      ...
      { name: 'camiseta_1', label: 'Camiseta 1', type: 'imagen', carpeta: 'equipos' },
      { name: 'camiseta_2', label: 'Camiseta 2', type: 'imagen', carpeta: 'equipos' },
      { name: 'camiseta_3', label: 'Camiseta 3', type: 'imagen', carpeta: 'equipos' },
      { name: 'camiseta_1_reverso', label: 'Camiseta 1 (reverso)', type: 'imagen', carpeta: 'equipos' },
      { name: 'camiseta_2_reverso', label: 'Camiseta 2 (reverso)', type: 'imagen', carpeta: 'equipos' },
      { name: 'camiseta_3_reverso', label: 'Camiseta 3 (reverso)', type: 'imagen', carpeta: 'equipos' },
      { name: 'id_externo_api', label: 'ID externo API' },
